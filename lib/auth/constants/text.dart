...
const emailValidationText = "Please enter a valid email";
const passwordValidationText = "Please enter a valid password";

// signup form
const signupTitle = "Sign up";
const nameHintText = 'Full Name';
const nameLabelText = 'Full Name';
const nameValidatorText = "Please enter a valid name";
const emailHintTextSignup = "Email";
const emailLabelTextSignup = "Email";
const emailValidatorText = "Please enter a valid email";
const passwordHintTextSignup = "Password";
const passwordLabelTextSignup = "Password";
const passwordValidatorText = "Please enter a valid password";
const repeatPasswordHintText = "Repeat Password";
const repeatPasswordLabelText = "Repeat Password";
const repeatPasswordValidatorText = "Passwords don't match";
const genderDropDownHint = "Select gender";
const signupTokenLabelText = "SignupToken";
...
const switchToLoginButtonText = "Log in";
