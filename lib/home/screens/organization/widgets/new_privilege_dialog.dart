...
class NewPrivilegeDialog extends StatelessWidget {
  ...
  NewPrivilegeDialog({@required this.service, @required this.onUpdate})
      : assert(service != null),
                ...
                if (_formKey.currentState.validate()) {
                  ...
                  service
                    ...
                    CustomFlushbarError(
                      ...
                      body:
                          "We could not create the privilege. Please try again later",
                      context: context,
                    ...
                    CustomFlushbarSuccess(
                            title: "Success",
                            body:
                                "We have successfully created your new privilege!",
                            context: context)
                        .getFlushbar()
                        .show(context);
                    onUpdate();
